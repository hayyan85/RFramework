#ifndef OPTION_SCANNER_PROXYMODEL_HEADER
#define OPTION_SCANNER_PROXYMODEL_HEADER
...
namespace Framework
{
	namespace NEclipse
	{
		class OptionScanner_FilterProxyModel : public QSortFilterProxyModel
		{
			Q_OBJECT
		public:
			explicit OptionScanner_FilterProxyModel(OptionScanner* os,QObject *parent = 0);
