#ifndef EXPDATE_PROXYMODEL_HEADER
#define EXPDATE_PROXYMODEL_HEADER
...
namespace Framework
{
	namespace NEclipse
	{
		class ExpDate_FilterProxyModel : public QSortFilterProxyModel
		{
			Q_OBJECT
		public:
			explicit ExpDate_FilterProxyModel(ExpGraph* os,QObject *parent = 0);
