...
public:
  ...
  bool selected() const { return mSelected; }
    void coordsToPixels(double key, double value, double &x, double &y) const; //moved
	const QPointF coordsToPixels(double key, double value) const;//moved
	void pixelsToCoords(double x, double y, double &key, double &value) const;//moved
	void pixelsToCoords(const QPointF &pixelPos, double &key, double &value) const;//moved
  // setters:
